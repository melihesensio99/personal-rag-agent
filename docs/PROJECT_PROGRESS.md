...
- [ ] Hybrid search nedir?
- [x] Re-ranking nedir?
  - Not: Semantic answer akışına local `BAAI/bge-reranker-v2-m3` Cross-Encoder eklendi; yapılandırılabilir `MinimumRerankScore` (varsayılan `0.5001`) altında kalan chunk'lar LLM'e gönderilmiyor.
